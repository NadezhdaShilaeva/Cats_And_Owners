...
class CatServiceTest {
    ...
    void setName_getCatWithNewName() {
        ...
        assertEquals(new CatDto(1L, "Alex", catPersikBirthday.getTime(), "domestic", "RED"), catDto);
    }
    ...
    void setBirthdate_getCatWithNewBirthdate() {
        ...
        assertEquals(new CatDto(1L, "Persik", catVasyaBirthday.getTime(), "domestic", "RED"), catDto);
    }
    ...
    void setBreed_getCatWithNewBreed() {
        ...
        assertEquals(new CatDto(1L, "Persik", catPersikBirthday.getTime(), "Persian", "RED"), catDto);
    }
    ...
    void setColor_getCatWithNewColor() {
        ...
        assertEquals(new CatDto(1L, "Persik", catPersikBirthday.getTime(), "domestic", "WHITE"), catDto);
    }
