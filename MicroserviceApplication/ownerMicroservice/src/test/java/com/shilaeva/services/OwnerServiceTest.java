...
class OwnerServiceTest {
    ...
    void findCats_getListOfOwnerCats() {
        ...
        CatDto catPersikDto = new CatDto(1L, "Persik", BirthdateDto.asBirthdateDto(catPersikBirthday.getTime()),
                "domestic", "RED");
        CatDto catVasyaDto = new CatDto(2L, "Vasya", BirthdateDto.asBirthdateDto(catVasyaBirthday.getTime()),
                "British", "GREY");
    ...
    void setName_getOwnerWithNewName() {
        ...
        assertEquals(new OwnerDto(1L, "Natalya", BirthdateDto.asBirthdateDto(ownerBirthday.getTime())), ownerDto);
    }
    ...
    void setBirthdate_getOwnerWithNewBirthdate() {
        ...
        assertEquals(new OwnerDto(1L, "Nadezhda", BirthdateDto.asBirthdateDto(newBirthday.getTime())), ownerDto);
    }
